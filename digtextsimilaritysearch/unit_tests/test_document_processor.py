...
class TestDocumentProcessor(unittest.TestCase):
    ...
    def test_vector_creation(self):
        ...
        self.assertEqual(r['sentence_id'], 'e36da14c6246c2f737925284002249e91583f94c06a3f95a56cb8733364ec696_37')
        self.assertEqual(r['sentence_text'], '+    Return on Equity 11.2%')
